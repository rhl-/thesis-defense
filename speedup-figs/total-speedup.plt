set terminal epslatex monochrome
            set output 'total-speedup.tex'
            set key top left
            set xrange [ 2 : 10  ]
            set yrange [ 0.002620642  : 3.801867  ]
	    set mytics 2
...
plot 'total-speedup.dat' u 1:2 t '\bunny' w lp ls 1, \
'total-speedup.dat' u 1:4 t '\blobs' w lp ls 2, \
'total-speedup.dat' u 1:6 t '\clique' w lp ls 3, \
'total-speedup.dat' u 1:8 t '\gnp' w lp ls 4, \
'total-speedup.dat' u 1:10 t '\sphere' w lp ls 5 
